...
$save_url = ALump_Common::realUrl($save_url);
...
if (empty($_FILES) === false) {
	 ...
	 * 存入数据库
	 */
	$created = ALump_Date::toTimestamp(ALump_Date::getNow());
	...
	$json_filedata = $json->encode($dataArr);
	$attach = new Alump_Post(array(
			"title" => $new_file_name,
			"content" => $json_filedata,
			"created" => $created,
			"modified" => $created,
