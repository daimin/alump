...
<div id="message" class="updated" style="display: none;">
  ...
  <td >
     ...
     ?>
     <?php $categorys->parse('<option value="{slug}">{name}</option>',  $post->category()->slug)?>
     </select></span> 
     </td>
     <td>
...
<!--     <div>引用通告<span class="narrator">( 每一行一个引用地址, 用回车隔开 )</span><br/><textarea name="trackback" cols="110" rows="4"></textarea></div> -->
    ...
    <td nowrap="nowrap">
        ...
        <td colspan="3" >
           ...
           <input type="checkbox" name="can_rss" id="can_rss" value="1"  checked="checked" <?php $post->allowFeed(' checked="checked" ')?>/>
