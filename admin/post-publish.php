...
<div class="admin_page_name">已发布文章<a class="link_button" href="post-add.php">撰写文章</a></div>
<div class="table_list_tool">
  <span>
  批量操作：<a  href="javascript:void(0)" onclick="apply_all('delete', 'ids')">删除</a>，<a  href="javascript:void(0)" onclick="apply_all('todraft', 'ids')">转为草稿</a>
  &nbsp;&nbsp;&nbsp;&nbsp;
...
<table colspan="0" rowspan="0" cellpadding="0" cellspacing="0" class="table_list">
  ...
  <tbody>
  <?php ALump::Lump('Contents_Post_Publish_Admin')->to($posts); ?>
       <?php if($posts->have()){ ?>
